...
function Skills({}: Props) {
  return (
    <motion.div
      ...
      className="h-screen flex relative flex-col justify-center text-center md:text-left xl:flex-row max-w-[2000px] xl:px-10 min-h-screen xl:space-x-0 items-center"
    >
